...
f.even:
	...
	addi	x2, x2, -4
	mv	x11, x10
# was:	mv	_param_a_28_, x10
# 	mv	_div1_L_34_,_param_a_28_
	li	x10, 2
# was:	li	_div2_R_35_, 2
	bne	x10, x0, l.safe_div_36_
# was:	bne	_div2_R_35_, x0, l.safe_div_36_
	li	x10, 6
# was:	li	x10, 6
	la	x11, m.DivZero
...
# was:	sw	_size_68_, 0(_let_a2df_67_)
	addi	x23, x19, 4
# was:	addi	_addr_73_, _let_a2df_67_, 4
	addi	x20, x20, 4
# was:	addi	_arr_69_, _arr_69_, 4
	mv	x22, x0
# was:	mv	_i_74_, x0
	mv	x24, x0
# was:	mv	_count_72_, x0
l.loop_beg_75_:
	bge	x22, x18, l.loop_end_76_
# was:	bge	_i_74_, _size_68_, l.loop_end_76_
	lw	x21, 0(x20)
# was:	lw	_elem_70_, 0(_arr_69_)
	addi	x20, x20, 4
# was:	addi	_arr_69_, _arr_69_, 4
	mv	x10, x21
# was:	mv	_arr_80_, _elem_70_
	lw	x12, 0(x10)
...
# 	mv	_bool_71_,_fun_arg_res_78_
	beq	x10, x0, l.if_end_77_
# was:	beq	_bool_71_, x0, l.if_end_77_
	sw	x21, 0(x23)
# was:	sw	_elem_70_, 0(_addr_73_)
	addi	x23, x23, 4
# was:	addi	_addr_73_, _addr_73_, 4
	addi	x24, x24, 1
# was:	addi	_count_72_, _count_72_, 1
l.if_end_77_:
	addi	x22, x22, 1
...
l.loop_end_76_:
	sw	x24, 0(x19)
# was:	sw	_count_72_, 0(_let_a2df_67_)
	mv	x10, x19
