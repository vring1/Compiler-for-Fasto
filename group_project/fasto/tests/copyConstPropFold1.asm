...
# was:	addi	_i_7_, _i_7_, 1
	j	l.loop_beg_8_
l.loop_end_9_:
# 	mv	_divide_L_12_,_let_length_2_
	li	x12, 10
# was:	li	_divide_R_13_, 10
	beq	x12, x0, l.divByZero_14_
# was:	beq	_divide_R_13_, x0, l.divByZero_14_
	div	x11, x13, x12
# was:	div	_let_index_11_, _divide_L_12_, _divide_R_13_
	j	l.divByZero_14_
l.divByZero_14_:
